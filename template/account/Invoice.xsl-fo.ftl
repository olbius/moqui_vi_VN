...
<#macro productItemRow invoiceItem invoiceItemList itemIndex>
    ...
    <fo:table-row font-size="8pt" border-bottom="thin solid black">
        ...
        <fo:table-cell padding="${cellPadding}">
            ...
            <#if invoiceItem.otherPartyProductId?has_content><fo:block>${ec.l10n.localize("Your Product")}: <@encodeText invoiceItem.otherPartyProductId/></fo:block></#if>
        </fo:table-cell>
...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" font-family="${fontArial}, sans-serif" font-size="10pt">
    ...
    <fo:page-sequence master-reference="letter-portrait" id="mainSequence">
        <fo:static-content flow-name="xsl-region-before">
            <fo:block-container absolute-position="absolute" top="0in" left="0in" width="3in">
                ...
                <#else>
                    <fo:block font-size="13pt" text-align="center" font-weight="bold"><@encodeText (fromParty.partyName)!""/></fo:block>
                    <fo:block font-size="12pt" text-align="center" margin-bottom="0.1in">${ec.l10n.localize("Invoice")}</fo:block>
                </#if>
            </fo:block-container>
            ...
            <fo:block-container absolute-position="absolute" top="0in" right="0in" width="2.0in">
                ...
                <#if fromContactInfo.telecomNumber?has_content>
                    <fo:block>ĐT: <#if fromContactInfo.telecomNumber.countryCode?has_content>${fromContactInfo.telecomNumber.countryCode}-</#if><#if fromContactInfo.telecomNumber.areaCode?has_content>${fromContactInfo.telecomNumber.areaCode}-</#if>${fromContactInfo.telecomNumber.contactNumber!""}</fo:block>
                </#if>
                <#if fromContactInfo.faxTelecomNumber?has_content>
                    <fo:block>Fax: <#if fromContactInfo.faxTelecomNumber.countryCode?has_content>${fromContactInfo.faxTelecomNumber.countryCode}-</#if><#if fromContactInfo.faxTelecomNumber.areaCode?has_content>${fromContactInfo.faxTelecomNumber.areaCode}-</#if>${fromContactInfo.faxTelecomNumber.contactNumber!""}</fo:block>
                </#if>
                <#if fromContactInfo.emailAddress?has_content><fo:block>E-mail: ${fromContactInfo.emailAddress}</fo:block></#if>
                </fo:block>
                <#--
                    ...
                    <fo:instream-foreign-object>
                        <barcode:barcode xmlns:barcode="http://barcode4j.krysalis.org/ns" message="${invoiceId}">
                            ...
                            <barcode:human-readable>
                                ...
                                <barcode:font-name>${fontArial}</barcode:font-name>
        ...
        <fo:static-content flow-name="xsl-region-after" font-size="8pt">
            <fo:block border-top="thin solid black">
                ...
                <fo:block text-align="center"><@encodeText (fromParty.partyName)!""/> ${ec.l10n.localize("Invoice")} #${invoiceId} -- ${ec.l10n.format(invoice.invoiceDate, dateFormat)} -- ${ec.l10n.localize("Page")} <fo:page-number/><#-- of <fo:page-number-citation-last ref-id="mainSequence"/>--></fo:block>
            </fo:block>
        </fo:static-content>
        ...
        <fo:flow flow-name="xsl-region-body">
            <fo:block-container width="7.5in" height="0.8in">
                <fo:table table-layout="fixed" margin-bottom="0.2in" width="7.5in"><fo:table-body><fo:table-row>
                    <fo:table-cell padding="3pt" width="1.75in">
                        <fo:block font-weight="bold">${ec.l10n.localize("Invoice")} #</fo:block>
                    ...
                    <#if invoice.referenceNumber?has_content || invoice.otherPartyOrderId?has_content>
                        <fo:table-cell padding="3pt" width="1.75in">
                            <#if invoice.referenceNumber?has_content>
                                <fo:block font-weight="bold">${ec.l10n.localize("Ref")} #</fo:block>
                                <fo:block><@encodeText invoice.referenceNumber/></fo:block>
                            </#if>
                            <#if invoice.otherPartyOrderId?has_content>
                                <fo:block font-weight="bold">${ec.l10n.localize("Your Order")}</fo:block>
                    ...
                    <fo:table-cell padding="3pt" width="2in">
                        ...
                        <fo:block font-weight="bold">${ec.l10n.localize("Invoice Date")}</fo:block>
                        <fo:block>${ec.l10n.format(invoice.invoiceDate, dateFormat)}</fo:block>
                    </fo:table-cell>
                    <#if orderIdSet?has_content>
                        <fo:table-cell padding="3pt" width="2in">
                            <fo:block font-weight="bold">${ec.l10n.localize("Our Order")}</fo:block>
            ...
            <fo:table table-layout="fixed" margin-bottom="0.2in" width="7.5in"><fo:table-body><fo:table-row>
                ...
                <fo:table-cell padding="3pt" width="4.5in">
                    ...
                    <#if toBillingRep?has_content><fo:block>${ec.l10n.localize("Attention")}: <@encodeText (toBillingRep.partyName)!""/></fo:block></#if>
                        <fo:block><@encodeText (toParty.partyName)!""/></fo:block>
                    ...
                    <fo:block-container margin-left="0.5in"><fo:block font-size="8pt">
                        <#if toContactInfo.telecomNumber?has_content>ĐT: <#if toContactInfo.telecomNumber.countryCode?has_content>${toContactInfo.telecomNumber.countryCode}-</#if><#if toContactInfo.telecomNumber.areaCode?has_content>${toContactInfo.telecomNumber.areaCode}-</#if>${toContactInfo.telecomNumber.contactNumber!""}</#if>
                        <#if toContactInfo.emailAddress?has_content>E-mail: <@encodeText toContactInfo.emailAddress/></#if>
                    </fo:block></fo:block-container>
                </fo:table-cell>
                <fo:table-cell padding="3pt" width="3in">
                    <#if !showOrig>
                        <#if unpaidTotal == 0>
                            <fo:block font-weight="bold">${ec.l10n.localize("PAID IN FULL")}</fo:block>
                        <#else>
                    ...
                    <#if showOrig || unpaidTotal != 0>
                        <#if invoice.dueDate??>
                            <fo:block font-weight="bold">${ec.l10n.localize("Due Date")}</fo:block>
                            <fo:block>${ec.l10n.format(invoice.dueDate, dateFormat)}</fo:block>
                        </#if>
                        <#if settlementTerm?has_content>
                            <fo:block font-weight="bold">${ec.l10n.localize("Term")}</fo:block>
            ...
            <#if hasProductItems && !hasTimeEntryItems>
                <fo:table table-layout="fixed" width="100%">
                    <fo:table-header font-size="9pt" border-bottom="solid black">
                        <fo:table-cell width="0.4in" padding="${cellPadding}"><fo:block text-align="center">${ec.l10n.localize("Item")}</fo:block></fo:table-cell>
                        <fo:table-cell width="1in" padding="${cellPadding}"><fo:block>${ec.l10n.localize("Product")}</fo:block></fo:table-cell>
                        <fo:table-cell width="1in" padding="${cellPadding}"><fo:block>${ec.l10n.localize("Lot")}</fo:block></fo:table-cell>
                        <fo:table-cell width="2.5in" padding="${cellPadding}"><fo:block>${ec.l10n.localize("Description")}</fo:block></fo:table-cell>
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row font-size="9pt" border-top="solid black">
                            ...
                            <fo:table-cell padding="${cellPadding}"><fo:block> </fo:block></fo:table-cell>
                            <fo:table-cell padding="${cellPadding}"><fo:block> </fo:block></fo:table-cell>
                            <fo:table-cell padding="${cellPadding}"><fo:block text-align="right" font-weight="bold">${ec.l10n.localize("Total")}</fo:block></fo:table-cell>
            ...
            <#else>
                <fo:table table-layout="fixed" width="100%">
                    <fo:table-header font-size="9pt" border-bottom="solid black">
                        ...
                        <fo:table-cell width="1in" padding="${cellPadding}"><fo:block>${ec.l10n.localize("Type")}</fo:block></fo:table-cell>
                        <fo:table-cell width="0.8in" padding="${cellPadding}"><fo:block>${ec.l10n.localize("Date")}</fo:block></fo:table-cell>
            ...
            <fo:table table-layout="fixed" width="100%" margin-top="0.1in">
                <fo:table-header font-size="9pt" border-bottom="solid black">
                    <fo:table-cell width="2.0in" padding="${cellPadding}"><fo:block>${ec.l10n.localize("Type")}</fo:block></fo:table-cell>
                    <#if hasTimeEntryItems><fo:table-cell width="1.2in" padding="${cellPadding}"><fo:block text-align="right">${ec.l10n.localize("Amount")}</fo:block></fo:table-cell></#if>
                    <fo:table-cell width="1.0in" padding="${cellPadding}"><fo:block text-align="center">${ec.l10n.localize("Qty")}</fo:block></fo:table-cell>
                    <fo:table-cell width="1.2in" padding="${cellPadding}"><fo:block text-align="right">${ec.l10n.localize("Total")}</fo:block></fo:table-cell>
                </fo:table-header>
                <fo:table-body>
                ...
                <fo:table-row font-size="9pt">
                    ...
                    <fo:table-cell padding="${cellPadding}" font-weight="bold"><fo:block text-align="right">${ec.l10n.localize("Total")}</fo:block></fo:table-cell>
            ...
            <#if !showOrig && adjustmentItemList?has_content>
                <fo:table table-layout="fixed" width="100%" margin-top="0.1in">
                    <fo:table-header font-size="9pt" border-bottom="solid black">
                        <fo:table-cell width="1in" padding="${cellPadding}"><fo:block text-align="center">${ec.l10n.localize("Adjustment")}</fo:block></fo:table-cell>
                        <fo:table-cell width="4in" padding="${cellPadding}"><fo:block>${ec.l10n.localize("Description")}</fo:block></fo:table-cell>
                        <fo:table-cell width="1in" padding="${cellPadding}"><fo:block text-align="center">${ec.l10n.localize("Date")}</fo:block></fo:table-cell>
                        <fo:table-cell width="1in" padding="${cellPadding}"><fo:block text-align="right">${ec.l10n.localize("Amount")}</fo:block></fo:table-cell>
                    </fo:table-header>
                    <fo:table-body>
                        ...
                        <fo:table-row font-size="9pt" border-top="solid black">
                            <fo:table-cell padding="${cellPadding}"><fo:block> </fo:block></fo:table-cell>
                            <fo:table-cell padding="${cellPadding}"><fo:block text-align="right" font-weight="bold">${ec.l10n.localize("Adjustments Total")}</fo:block></fo:table-cell>
                            <fo:table-cell padding="${cellPadding}"><fo:block> </fo:block></fo:table-cell>
                        ...
                        <fo:table-row font-size="9pt" border-top="solid black">
                            <fo:table-cell padding="${cellPadding}"><fo:block> </fo:block></fo:table-cell>
                            <fo:table-cell padding="${cellPadding}"><fo:block text-align="right" font-weight="bold">${ec.l10n.localize("Invoice Total")}</fo:block></fo:table-cell>
                            <fo:table-cell padding="${cellPadding}"><fo:block> </fo:block></fo:table-cell>
        ...
        <#if !showOrig && paymentApplicationList?has_content>
            <fo:block font-size="10pt" font-weight="bold" margin-top="0.1in">${ec.l10n.localize("Applied Payments")}</fo:block>
            <fo:table table-layout="fixed" width="100%">
                <fo:table-header font-size="9pt" border-bottom="solid black">
                    <fo:table-cell width="1in" padding="${cellPadding}"><fo:block>${ec.l10n.localize("Payment")}</fo:block></fo:table-cell>
                    <fo:table-cell width="2in" padding="${cellPadding}"><fo:block>${ec.l10n.localize("Ref/Check")}</fo:block></fo:table-cell>
                    <fo:table-cell width="1in" padding="${cellPadding}"><fo:block text-align="right">${ec.l10n.localize("Amount")}</fo:block></fo:table-cell>
                    <fo:table-cell width="1in" padding="${cellPadding}"><fo:block text-align="center">${ec.l10n.localize("Date")}</fo:block></fo:table-cell>
                    <fo:table-cell width="1in" padding="${cellPadding}"><fo:block text-align="right">${ec.l10n.localize("Applied")}</fo:block></fo:table-cell>
                </fo:table-header>
                <fo:table-body>
                    <#list paymentApplicationList as paymentAppl>
                        ...
                        <fo:table-row font-size="8pt" border-bottom="thin solid black">
                            <fo:table-cell padding="${cellPadding}"><fo:block><#if otherInvoiceId?has_content>${ec.l10n.localize("Invc")} ${otherInvoiceId}<#else>${paymentAppl.paymentId}</#if></fo:block></fo:table-cell>
                    ...
                    <fo:table-row font-size="9pt" border-top="solid black">
                        ...
                        <fo:table-cell padding="${cellPadding}"><fo:block> </fo:block></fo:table-cell>
                        <fo:table-cell padding="${cellPadding}"><fo:block> </fo:block></fo:table-cell>
                        <fo:table-cell padding="${cellPadding}"><fo:block text-align="right" font-weight="bold">${ec.l10n.localize("Payments Total")}</fo:block></fo:table-cell>
