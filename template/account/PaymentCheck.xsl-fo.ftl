...
<#macro checkBody paymentInfo>
    ...
    <fo:block-container absolute-position="absolute" top="2in" left="1.1in" width="4in" height="0.8in">
        ...
        <#if (contactInfo.postalAddress.toName)?has_content || (contactInfo.postalAddress.attnName)?has_content>
            ...
            <#if (contactInfo.postalAddress.attnName)?has_content><fo:block text-align="left">${ec.l10n.localize("Attn")}: <@encodeText contactInfo.postalAddress.attnName/></fo:block></#if>
        <#else>
            <fo:block text-align="left"><@encodeText (paymentInfo.toPartyDetail.partyName)!""/></fo:block>
        </#if>
