...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" font-family="${fontArial}, sans-serif" font-size="10pt">
    ...
    <fo:page-sequence master-reference="letter-portrait">
        <fo:static-content flow-name="xsl-region-before">
            ...
            <fo:block font-size="12pt" text-align="center" margin-bottom="0.1in">${ec.l10n.localize("Shipment Picklist")}</fo:block>
        ...
        <fo:static-content flow-name="xsl-region-after" font-size="8pt">
            <fo:block border-top="thin solid black">
                ...
                -->
                <fo:block text-align="center">${ec.l10n.localize("Picklist for Shipment")} #${shipmentId} -- <#if shipment.estimatedShipDate??>${ec.l10n.format(shipment.estimatedShipDate, dateFormat)} -- </#if>${ec.l10n.localize("Printed")} ${ec.l10n.format(ec.user.nowTimestamp, dateTimeFormat)} -- ${ec.l10n.localize("Page")} <fo:page-number/></fo:block>
            </fo:block>
        </fo:static-content>
        ...
        <fo:flow flow-name="xsl-region-body">
            <fo:table table-layout="fixed" margin-bottom="0.1in" width="7.5in">
                <fo:table-body><fo:table-row>
                    ...
                    <fo:table-cell padding="3pt" width="3in">
                        <fo:block><@encodeText toPartyDetail.partyName!""/></fo:block>
            ...
            <#if productInfoList?has_content>
                <fo:table table-layout="fixed" width="7.5in" border-bottom="solid black" margin-top="10pt">
                    <fo:table-header font-size="9pt" font-weight="bold" border-bottom="solid black">
                        <fo:table-cell width="1.4in" padding="${cellPadding}"><fo:block text-align="left">${ec.l10n.localize("By Product")}</fo:block></fo:table-cell>
                        ...
                        <fo:table-cell width="0.8in" padding="${cellPadding}"><fo:block text-align="center">${ec.l10n.localize("Cont")}</fo:block></fo:table-cell>

                        <fo:table-cell width="2.8in" padding="${cellPadding}"><fo:block>${ec.l10n.localize("Lot")}</fo:block></fo:table-cell>
                    ...
                    <#list productInfoList as productInfo>
                        <fo:table-row font-size="9pt" border-top="solid black">
                            ...
                            <fo:table-cell padding="${cellPadding}" number-columns-spanned="5"><fo:block text-align="left"><@encodeText ec.resource.expand("ProductNameTemplate", "", productInfo)/></fo:block></fo:table-cell>
                        ...
                        <#if productInfo.reservedLocationInfoList?has_content><#list productInfo.reservedLocationInfoList as locationInfo>
                            <fo:table-row font-size="9pt" border-top="thin solid black">
                                <fo:table-cell padding="${cellPadding}"><fo:block text-align="left">(${ec.l10n.localize("Res")}) <@encodeText locationInfo.description!" "/></fo:block></fo:table-cell>
                                ...
                                <fo:table-cell padding="${cellPadding}"><fo:block text-align="center">${(locationInfo.container.serialNumber)!(locationInfo.container.containerId)!" "}</fo:block></fo:table-cell>
                        ...
                        <#if productInfo.otherLocationInfoList?has_content><#list productInfo.otherLocationInfoList as locationInfo>
                            <fo:table-row font-size="9pt" border-top="thin solid black">
                                <fo:table-cell padding="${cellPadding}"><fo:block text-align="left">(${ec.l10n.localize("Alt")}) <@encodeText locationInfo.description!" "/></fo:block></fo:table-cell>
                                <fo:table-cell padding="${cellPadding}"><fo:block text-align="center">${locationInfo.areaId!" "}</fo:block></fo:table-cell>
                                <fo:table-cell padding="${cellPadding}"><fo:block text-align="center">${locationInfo.aisleId!" "}</fo:block></fo:table-cell>
                                <fo:table-cell padding="${cellPadding}"><fo:block text-align="center">${locationInfo.sectionId!" "}</fo:block></fo:table-cell>
                                <fo:table-cell padding="${cellPadding}"><fo:block text-align="center">${locationInfo.levelId!" "}</fo:block></fo:table-cell>
...
<#macro locationInfoTable locationInfoList titleString>
    <fo:table table-layout="fixed" width="7.5in" border-bottom="solid black">
        <fo:table-header font-size="9pt" font-weight="bold" border-bottom="solid black">
            <fo:table-cell width="1.4in" padding="${cellPadding}"><fo:block text-align="left">${ec.l10n.localize("titleString")}</fo:block></fo:table-cell>
            <fo:table-cell width="0.3in" padding="${cellPadding}"><fo:block text-align="center">${ec.l10n.localize("Ar")}</fo:block></fo:table-cell>
            <fo:table-cell width="0.3in" padding="${cellPadding}"><fo:block text-align="center">${ec.l10n.localize("Ais")}</fo:block></fo:table-cell>
            <fo:table-cell width="0.3in" padding="${cellPadding}"><fo:block text-align="center">${ec.l10n.localize("Sec")}</fo:block></fo:table-cell>
            <fo:table-cell width="0.3in" padding="${cellPadding}"><fo:block text-align="center">${ec.l10n.localize("Lev")}</fo:block></fo:table-cell>
            <fo:table-cell width="0.3in" padding="${cellPadding}"><fo:block text-align="center">${ec.l10n.localize("Pos")}</fo:block></fo:table-cell>
            <fo:table-cell width="0.6in" padding="${cellPadding}"><fo:block text-align="center">${ec.l10n.localize("Cont")}</fo:block></fo:table-cell>

            <fo:table-cell width="3.0in" padding="${cellPadding}"><fo:block>${ec.l10n.localize("Lot")}</fo:block></fo:table-cell>
            <fo:table-cell width="0.5in" padding="${cellPadding}"><fo:block text-align="center">${ec.l10n.localize("Bin")}</fo:block></fo:table-cell>
            <fo:table-cell width="0.5in" padding="${cellPadding}"><fo:block text-align="right">${ec.l10n.localize("Quantity")}</fo:block></fo:table-cell>
        </fo:table-header>
        <fo:table-body>
