...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" font-family="${fontArial}, sans-serif" font-size="10pt">
    ...
    <fo:page-sequence master-reference="letter-portrait">
        ...
        <#if fromPartyDetail?has_content><fo:block font-size="14pt" text-align="center"><@encodeText fromPartyDetail.partyName!""/></fo:block></#if>
            <fo:block font-size="12pt" text-align="center" margin-bottom="0.1in">${ec.l10n.localize("Shipment by Package")}</fo:block>
        ...
        <fo:static-content flow-name="xsl-region-after" font-size="8pt">
            <fo:block border-top="thin solid black">
                <fo:block text-align="center">${ec.l10n.localize("Packages for Shipment")} #${shipmentId} -- <#if shipment.estimatedShipDate??>${ec.l10n.format(shipment.estimatedShipDate, dateFormat)} -- </#if>${ec.l10n.localize("Printed")} ${ec.l10n.format(ec.user.nowTimestamp, dateTimeFormat)} -- ${ec.l10n.localize("Page")} <fo:page-number/></fo:block>
            </fo:block>
        </fo:static-content>
        ...
        <fo:flow flow-name="xsl-region-body">
            <fo:table table-layout="fixed" margin-bottom="0.1in" width="7.5in"><fo:table-body><fo:table-row>
                <fo:table-cell padding="3pt" width="3in">
                    <fo:block font-weight="bold">${ec.l10n.localize("Shipment")} #</fo:block>
                    <fo:block>${shipmentId}</fo:block>
                    <#if orderPartList?has_content>
                        <fo:block font-weight="bold">${ec.l10n.localize("Order")}</fo:block>
                    ...
                    <#if originFacility?has_content>
                        <fo:block font-weight="bold">${ec.l10n.localize("Origin Facility")}</fo:block>
                        <fo:block><@encodeText ec.resource.expand("FacilityNameTemplate", "", originFacility)/></fo:block>
                    </#if>
                    <#if destinationFacility?has_content>
                        <fo:block font-weight="bold">${ec.l10n.localize("Destination Facility")}</fo:block>
                ...
                <fo:table-cell padding="3pt" width="3in">
                    <#if toPartyDetail?has_content>
                        <fo:block font-weight="bold">${toPartyDetail.pseudoId}: <@encodeText (toPartyDetail.partyName)!""/></fo:block>
                    </#if>
                <#if toContactInfo.postalAddress?has_content>
                    ...
                    <#else>
                        <fo:block font-weight="bold"><@encodeText (toPartyDetail.partyName)!""/></fo:block>
                    </#if>
            ...
            <#if shipment.handlingInstructions?has_content>
                <fo:block font-weight="bold" margin-top="0.1in">${ec.l10n.localize("Shipping Instructions")}</fo:block>
        ...
        <#list packageInfoList as packageInfo>
            <fo:table table-layout="fixed" margin-top="0.1in" width="7.5in"><fo:table-body><fo:table-row>
                <fo:table-cell padding="3pt" width="1.5in"><fo:block>
                    <fo:inline font-weight="bold">${ec.l10n.localize("Package")}</fo:inline> ${packageInfo.shipmentPackage.shipmentPackageSeqId}
                </fo:block></fo:table-cell>
                <fo:table-cell padding="3pt" width="3.5in"><fo:block>
                    <fo:inline font-weight="bold">${ec.l10n.localize("Box Type")}</fo:inline> ${(packageInfo.shipmentBoxType.description)!''}
                </fo:block></fo:table-cell>
                <fo:table-cell padding="3pt" width="2.5in"><fo:block>
                    <fo:inline font-weight="bold">${ec.l10n.localize("Weight")}</fo:inline> ${ec.l10n.format((packageInfo.shipmentPackage.weight)!, '')} ${(packageInfo.weightUom.description)!''}
                </fo:block></fo:table-cell>
            </fo:table-row></fo:table-body></fo:table>
            ...
            <fo:table table-layout="fixed" width="7.5in" border-bottom="solid black">
                <fo:table-header font-size="9pt" font-weight="bold" border-bottom="solid black">
                    <fo:table-cell width="0.75in" padding="2pt"><fo:block text-align="right">${ec.l10n.localize("Quantity")}</fo:block></fo:table-cell>
                    <fo:table-cell width="0.25in" padding="2pt"><fo:block> </fo:block></fo:table-cell>
                    <fo:table-cell width="4in" padding="2pt"><fo:block text-align="left">${ec.l10n.localize("Product")}</fo:block></fo:table-cell>
        ...
        <#if productInfoList?has_content>
            <fo:table table-layout="fixed" width="7.5in" border-bottom="solid black" margin-top="10pt">
                <fo:table-header font-size="9pt" font-weight="bold" border-bottom="solid black">
                    ...
                    <fo:table-cell width="1.5in" padding="${cellPadding}"><fo:block text-align="left">${ec.l10n.localize("By Product")}</fo:block></fo:table-cell>
                    <fo:table-cell width="0.3in" padding="${cellPadding}"><fo:block text-align="center">${ec.l10n.localize("Ar")}</fo:block></fo:table-cell>
                    <fo:table-cell width="0.3in" padding="${cellPadding}"><fo:block text-align="center">${ec.l10n.localize("Ais")}</fo:block></fo:table-cell>
                    <fo:table-cell width="0.3in" padding="${cellPadding}"><fo:block text-align="center">${ec.l10n.localize("Sec")}</fo:block></fo:table-cell>
                    <fo:table-cell width="0.3in" padding="${cellPadding}"><fo:block text-align="center">${ec.l10n.localize("Lev")}</fo:block></fo:table-cell>
                    <fo:table-cell width="0.3in" padding="${cellPadding}"><fo:block text-align="center">${ec.l10n.localize("Pos")}</fo:block></fo:table-cell>

                    <fo:table-cell width="3.0in" padding="${cellPadding}"><fo:block>Lot</fo:block></fo:table-cell>
                    <fo:table-cell width="0.5in" padding="${cellPadding}"><fo:block text-align="center">${ec.l10n.localize("Bin")}</fo:block></fo:table-cell>
                    <fo:table-cell width="0.5in" padding="${cellPadding}"><fo:block text-align="right">${ec.l10n.localize("Quantity")}</fo:block></fo:table-cell>
                </fo:table-header>
                <fo:table-body>
                    <#list productInfoList as productInfo>
                        ...
                        <#if productInfo.reservedLocationInfoList?has_content><#list productInfo.reservedLocationInfoList as locationInfo>
                            <fo:table-row font-size="9pt" border-top="thin solid black">
                                <fo:table-cell padding="${cellPadding}"><fo:block text-align="left" font-weight="bold">${ec.l10n.localize("Res")}</fo:block></fo:table-cell>
                        ...
                        <#if productInfo.otherLocationInfoList?has_content><#list productInfo.otherLocationInfoList as locationInfo>
                            <fo:table-row font-size="9pt" border-top="thin solid black">
                                <fo:table-cell padding="${cellPadding}"><fo:block text-align="left" font-weight="bold">${ec.l10n.localize("Alt")}</fo:block></fo:table-cell>
                                <fo:table-cell padding="${cellPadding}"><fo:block text-align="left">${locationInfo.description!" "}</fo:block></fo:table-cell>
                                <fo:table-cell padding="${cellPadding}"><fo:block text-align="center">${locationInfo.areaId!" "}</fo:block></fo:table-cell>
                                <fo:table-cell padding="${cellPadding}"><fo:block text-align="center">${locationInfo.aisleId!" "}</fo:block></fo:table-cell>
                                <fo:table-cell padding="${cellPadding}"><fo:block text-align="center">${locationInfo.sectionId!" "}</fo:block></fo:table-cell>
                        ...
                        <#if productInfo.productIssuedLocationInfoList?has_content><#list productInfo.productIssuedLocationInfoList as locationInfo>
                            <fo:table-row font-size="9pt" border-top="thin solid black">
                                <fo:table-cell padding="${cellPadding}"><fo:block text-align="left" font-weight="bold">${ec.l10n.localize("Iss")}</fo:block></fo:table-cell>
                                <fo:table-cell padding="${cellPadding}"><fo:block text-align="left">${locationInfo.description!" "}</fo:block></fo:table-cell>
                                <fo:table-cell padding="${cellPadding}"><fo:block text-align="center">${locationInfo.areaId!" "}</fo:block></fo:table-cell>
                                <fo:table-cell padding="${cellPadding}"><fo:block text-align="center">${locationInfo.aisleId!" "}</fo:block></fo:table-cell>
                                <fo:table-cell padding="${cellPadding}"><fo:block text-align="center">${locationInfo.sectionId!" "}</fo:block></fo:table-cell>
