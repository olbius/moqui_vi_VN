...
<#macro shipmentPackPageSequence shipmentInfo packageInfo packageInfo_index>
    ...
    <fo:page-sequence master-reference="letter-portrait" initial-page-number="1" force-page-count="no-force">
        <fo:static-content flow-name="xsl-region-before">
            ...
            <fo:block font-size="12pt" text-align="center" margin-bottom="0.1in">${ec.l10n.localize("Shipment Insert")}</fo:block>
        ...
        <fo:static-content flow-name="xsl-region-after" font-size="8pt">
            <fo:block border-top="thin solid black">
                ...
                <fo:block text-align="center">${ec.l10n.localize("Shipment")} #${shipmentId} -- <#if shipment.estimatedShipDate??>${ec.l10n.format(shipment.estimatedShipDate, dateFormat)} -- </#if>${ec.l10n.localize("Printed")} ${ec.l10n.format(ec.user.nowTimestamp, dateTimeFormat)}</fo:block>
            </fo:block>
        </fo:static-content>
        ...
        <fo:flow flow-name="xsl-region-body">
                ...
                <fo:table-body><fo:table-row>
                    <fo:table-cell padding="3pt" width="3.25in">
                        ...
                        <#if toContactInfo.postalAddress?has_content>
                            <#if toContactInfo.postalAddress.toName?has_content || toContactInfo.postalAddress.attnName?has_content>
                                <#if toContactInfo.postalAddress.toName?has_content><fo:block font-weight="bold">${ec.l10n.localize("To Name")}: <@encodeText toContactInfo.postalAddress.toName/></fo:block></#if>
                                <#if toContactInfo.postalAddress.attnName?has_content><fo:block font-weight="bold">${ec.l10n.localize("Attn Name")}: <@encodeText toContactInfo.postalAddress.attnName/></fo:block></#if>
                            <#else>
                    ...
                    <fo:table-cell padding="3pt" width="2.5in">
                        <#if carrierShipmentMethod?has_content>
                            <fo:block font-weight="bold">${ec.l10n.localize("Shipping Method")}</fo:block>
            ...
            <#if packageInfo?has_content && packageInfo.contentInfoList?has_content>
                ...
                <fo:table table-layout="fixed" width="7.5in" border-bottom="solid black" margin-top="0.2in">
                    <fo:table-header font-size="10pt" font-weight="bold" border-bottom="solid black">
                                <fo:table-cell width="3.9in" padding="2pt"><fo:block text-align="left">${ec.l10n.localize("Package")} ${packageInfo_index + 1} ${ec.l10n.localize("of")} ${packageInfoList?size}<#if routeSegments?has_content && routeSegments[0].trackingCode?has_content> (${routeSegments[0].trackingCode})</#if></fo:block></fo:table-cell>
                        <fo:table-cell width="1.2in" padding="2pt"><fo:block text-align="center">${ec.l10n.localize("Qty Ordered")}</fo:block></fo:table-cell>
                        <fo:table-cell width="1.2in" padding="2pt"><fo:block text-align="center">${ec.l10n.localize("Qty in Package")}</fo:block></fo:table-cell>
                        <fo:table-cell width="1.2in" padding="2pt"><fo:block text-align="center">${ec.l10n.localize("Total Shipped")}</fo:block></fo:table-cell>
                    </fo:table-header>
                    <fo:table-body>
                        <#list packageInfo.contentInfoList as contentInfo>
                            <fo:table-row font-size="10pt">
                                <fo:table-cell padding="2pt"><fo:block text-align="left"><@encodeText ec.resource.expand("ProductNameTemplate", "", contentInfo.productInfo)/></fo:block>
                                    <#if contentInfo.otherPartyProductId?has_content><fo:block>${ec.l10n.localize("Your Product")}: ${contentInfo.otherPartyProductId}</fo:block></#if></fo:table-cell>
            ...
            <fo:table table-layout="fixed" width="7.5in" border-bottom="solid black" margin-top="0.2in">
                <fo:table-header font-size="9pt" font-weight="bold" border-bottom="solid black">
                    <fo:table-cell width="4in" padding="${cellPadding}"><fo:block text-align="left">${ec.l10n.localize("Product in All Packages")}</fo:block></fo:table-cell>
                    <fo:table-cell width="1in" padding="${cellPadding}"><fo:block text-align="center">${ec.l10n.localize("Quantity")}</fo:block></fo:table-cell>
                    <fo:table-cell width="1.5in" padding="${cellPadding}"><fo:block text-align="center">${ec.l10n.localize("Price")}</fo:block></fo:table-cell>
                </fo:table-header>
                <fo:table-body>
