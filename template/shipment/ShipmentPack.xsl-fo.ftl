...
<#macro shipmentPackPageSequence shipmentInfo>
    ...
    <fo:page-sequence master-reference="letter-portrait" initial-page-number="1" force-page-count="no-force">
        <fo:static-content flow-name="xsl-region-before">
            ...
            <fo:block font-size="12pt" text-align="center" margin-bottom="0.1in">${ec.l10n.localize("Shipment Pack Sheet")}</fo:block>
            <#if logoImageLocation?has_content>
                <fo:block-container absolute-position="absolute" top="0in" left="0.1in" width="2in">
        ...
        <fo:static-content flow-name="xsl-region-after" font-size="8pt">
            <fo:block border-top="thin solid black">
                ...
                <fo:block text-align="center">${ec.l10n.localize("Shipment")} #${shipmentId} -- <#if shipment.estimatedShipDate??>${ec.l10n.format(shipment.estimatedShipDate, dateFormat)} -- </#if>${ec.l10n.localize("Printed")} ${ec.l10n.format(ec.user.nowTimestamp, dateTimeFormat)} -- ${ec.l10n.localize("Page")} <fo:page-number/></fo:block>
            </fo:block>
        </fo:static-content>
            ...
            <#if productInfoList?has_content>
                <fo:table table-layout="fixed" width="7.5in" border-bottom="solid black" margin-top="10pt">
                    <fo:table-header font-size="9pt" font-weight="bold" border-bottom="solid black">
                        <fo:table-cell width="3.5in" padding="${cellPadding}"><fo:block text-align="left">${ec.l10n.localize("ID Barcode")}</fo:block></fo:table-cell>
                        <fo:table-cell width="3in" padding="${cellPadding}"><fo:block text-align="left">${ec.l10n.localize("Product")}</fo:block></fo:table-cell>
